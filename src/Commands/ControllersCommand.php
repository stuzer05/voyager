...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/stuzer05/voyager/src/Http/Controllers'));
    ...
    {
        return $this->filesystem->get(base_path('/vendor/stuzer05/voyager/stubs/'.$this->stub));
    }
